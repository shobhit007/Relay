...
export function ChatScreen() {
  ...
  // KeyboardStickyView translates the composer up; pad the list by the same
  // animated keyboard height so messages stay visible without resizing the screen.
  ...
  const handleSend = useCallback(
    ...
    [conversationId, currentUserId, recipientId, router, scrollToEnd, sending],
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Icon name="ArrowLeft" size={24} color={colors.primaryText} />
        </Pressable>
      ...
      <Animated.View style={[{ flex: 1, minHeight: 0 }, listAnimatedStyle]}>
        {messages.length === 0 ? (
          <View
            style={{
              flex: 1,
